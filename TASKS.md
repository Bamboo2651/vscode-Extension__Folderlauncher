...
- [ ] **T-07** `FolderItem.ts` — TreeItem サブクラス（通常 / ルート）
...
- [ ] **T-17** `package.json` menus に右クリックメニュー定義（when 句でアイテム種別分岐）
- [ ] **T-18** パネルヘッダーにルート追加 `+` ボタン配置
...
```
T-01〜05（完了） → T-06（完了） → T-07〜10 → T-11 → T-12〜16 → T-17〜18 → T-19〜21 → T-22〜25
```
